...
export default function LoginPage(){
    ...
    return(
        <div
            className="h-screen flex justify-between items-center font-bold px-8"
            style={{
                backgroundImage: `url('/img/fruitection-bg.jpg')`,
        ...
        >
            ...
            <div className="w-[40%] h-[70%] bg-gray-200 rounded-md p-5 flex flex-col items-center justify-center">
